...
const SiaranPage: FC<SiaranPageProps> = ({ data, locale }) => {
  ...
  return (
    <main className="container grid auto-rows-auto grid-cols-1 py-12 md:grid-cols-12 lg:grid-cols-6 xl:grid-cols-4 print:mx-auto print:block print:w-[90vw] print:py-0">
