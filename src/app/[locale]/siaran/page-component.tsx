...
const SiaranList: FC<SiaranListProps> = ({ data, locale }) => {
  ...
  return (
    <>
      ...
      <main>
        <Section>
          <div className="flex flex-col gap-8 border-washed-100 py-12 lg:border-x">
            <div className="grid grid-cols-1 gap-3 md:grid-cols-2 md:gap-6 lg:grid-cols-3 lg:px-6">
              {data.docs.map((doc, i) => {
                const media =
