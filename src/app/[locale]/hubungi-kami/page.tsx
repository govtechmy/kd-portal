  ...
  return (
    <>
      ...
      <main className="divide-y divide-washed-100">
        ...
        <Section>
          <div className="grid grid-cols-2 divide-x px-0 max-lg:divide-y sm:grid-cols-4 lg:flex lg:divide-x lg:divide-washed-100 lg:border-x lg:border-x-washed-100">
            {[
              {
