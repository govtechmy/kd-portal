...
export function Header({ locale }: { locale: string }) {
  ...
  return (
    <header className="bg-background/80 sticky top-0 z-10 flex items-center border-b backdrop-blur-[30px]">
      <div className="container flex w-full gap-4 py-2">
        ...
        <NavigationMenu.Root className="z-10 hidden w-full flex-1 items-center lg:flex lg:grow">
