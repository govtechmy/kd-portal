...
export default function Quicklinks({
  ...
  const hasMyMesyuarat = items.some((item) => {
    ...
    return (
      link?.name?.toLowerCase().includes("mymes") ||
            ...
            <div className="grid grid-cols-1 gap-3 sm:gap-6 md:grid-cols-2 lg:grid-cols-3">
              ...
              {hasMyMesyuarat && (
                <a
                  ...
                  title="MyMesyuarat"
                >
                  <div className="flex size-[60px] select-none items-center justify-center rounded-lg border border-outline-200 bg-background-50 p-1">
                    <Image
              ...
              {items.map((item, i) => {
                ...
                const isOnlineService =
                  link?.name?.toLowerCase().includes("hrmis") ||
